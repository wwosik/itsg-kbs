...
public class M_004_Config : Migration
{
    ...
    public override void Up()
    {
        ...
        Create.Table("Config").WithDescription("Definition einer Eigenschaft vom Benutzer")
            ...
            .WithColumn("IsForFrontend").AsFixedLengthString(1, "Latin1_General_CI_AS").ForeignKey("FK_Config_IsForFrontend", "Ref_YesNo", "Value")
                .NotNullable().WithColumnDescription("Wenn Y, wird jedem Frontend-User ausgegeben")
